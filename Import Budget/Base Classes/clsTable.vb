...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            'AddTables("BUDGET_COUNTRY", "Budget Country", SAPbobsCOM.BoUTBTableType.bott_Document)
            'AddTables("BUDGET_COUNTRY_ROW", "Budget Country Row", SAPbobsCOM.BoUTBTableType.bott_DocumentLines)
            'AddFields("BUDGET_COUNTRY", "Year", "Year", SAPbobsCOM.BoFieldTypes.db_Numeric)
            'AddFields("BUDGET_COUNTRY_ROW", "AcctCode", "Account Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            'AddFields("BUDGET_COUNTRY_ROW", "AcctName", "Account Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            'AddFields("BUDGET_COUNTRY_ROW", "OcrCode1", "Country Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            'AddFields("BUDGET_COUNTRY_ROW", "OcrName1", "Country Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Jan", "January", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Feb", "Feburary", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Mar", "March", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Apr", "April", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_May", "May", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Jun", "June", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Jul", "July", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Aug", "August", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Sep", "October", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Nov", "November", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY_ROW", "Budget_Desc", "December", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("BUDGET_COUNTRY", "Total", "Total", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)


            ' addField("OINV", "IsImport", "Is Import", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None, "N,Y", "No,Yes", "")
            '---- User Defined Object
            CreateUDO()
